...
cd /d "%ROOT%"
cl /EHsc /utf-8 /Zi "%ROOT%\agent.cpp" /I "%ROOT%\YCodeEngine\third_party" /I "%VCPKG_INSTALLED%\include" /link /DEBUG /LIBPATH:"%VCPKG_INSTALLED%\lib" libcurl.lib shell32.lib /OUT:"%ROOT%\agent.exe"
if errorlevel 1 (
